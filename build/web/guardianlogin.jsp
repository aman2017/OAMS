<%-- 
    Document   : guardianlogin
    Created on : 7 May, 2015, 10:27:40 AM
    Author     : AmanDhiman
--%>
...
<html>
    ...
    <fieldset style="box-shadow: 10px 10px 10px #bbb;  border-radius: 10px;" >
        <legend style="background-color:  #D40400;">Guardian Login</legend>
<form method="post" action="guardiancheck.jsp">
